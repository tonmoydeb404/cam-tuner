...
import { triggerMediaOverlay } from "@/utils/media-overlay-trigger";
import { ImageIcon, Search, X } from "lucide-react";
import { useCallback, useEffect, useState } from "react";

const GifBrowser = () => {
  const { mediaOverlay } = useMediaOverlayContext();
  ...
  const handleGifSelect = useCallback(
    async (gif: KlipyGif) => {
      try {
        ...
        console.error("Failed to trigger media overlay:", error);
      }
    },
    [mediaOverlay]
  );
